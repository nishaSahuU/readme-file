...
## BUILDING A SKILL DEVELOPMENT PLATFORM "SKILL UNIVERSITY" WITH AI AND DATA ANALYTICS IN
 THE BACKEND
...
```
git clone https://github.com/projects4321/repo_name.git
```

where https://github.com/projects4321/repo_name.git is the url to this repository 
